								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack flex-wrap">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex title-custom fw-bolder fs-2hx flex-column justify-content-center my-0">Assign Complaint</h1>
											<!--end::Title-->
                        ...
                        <!--begin::Menu-->
                                ...
                                echo $doneResolved->tot_resolved;
                                    ...
                                    <div class="row g-6 mb-6 g-xl-9 mb-xl-9">
                                        <!--begin::Followers-->
                                       <?php 
                $result3 = $this->db->query("SELECT * FROM user as u where u.city_id=$city")->result();
                                ...
                                echo $doneResolved1->tot_resolved;
                                    ?></div>
                                                    ...
                                                    <!--begin::Follow-->
                                                       ...
                                                       <button class="btn btn-success">Assigned<i class="ki-duotone ki-check following fs-3"></i></button>
                                                    <?php  }
                                                    else{?>  
