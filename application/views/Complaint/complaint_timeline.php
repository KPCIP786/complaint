...
$userid=$this->session->userdata('userid');?><br>
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
				...
				<?php 
				$result2 = $this->db->query("SELECT * FROM gre_applicant AS ga,user as u,grm_complaint_category As gcc,gre_complaint_detail As gcd,grm_source_tbl As s,ppms_subproject As ps,grm_tier_tbl As t,grc_status_tbl As gs where ga.applicant_id=gcd.applicant_id AND gcc.cc_id=gcd.complaint_category_id AND s.source_id=gcd.source_id AND ps.subproject_id=gcd.sub_project_id AND t.tier_id=gcd.tier_id AND gs.status_id=gcd.status_id AND u.user_id=gcd.user_id AND gcd.complaint_detail_id=$aid")->row();?>
                         ...
                         <!--begin::Menu-->
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px pb-15" data-kt-menu="true">
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <!--begin::Menu-->
                                                            <div class="me-0">
                                                                <a href="<?php echo base_url('Complaint/unresolved_complaint_timeline/'.$aid)?>" class="btn btn-sm btn-danger me-3" >
                                                                   Mark as inprogress
                                                                </a>
                                                            </div>
                                                            <!--end::Menu-->
                                    ...
                                    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                                        ...
                                        <div class="card-body p-9">
                                            ...
                                            <div class="row mb-7">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <span class="fw-bold fs-6 text-gray-800"><?php echo $result2->name;?></span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Row-->
                                            ...
                                            <div class="row mb-7">
                                                ...
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <span class="fw-bold fs-6 text-gray-800 me-2"><?php if($result2->status_id==1){?>
                        <div class="text-gray-500 fw-semibold fs-6">
                  <span class="badge badge-light-warning badge-lg fw-bold me-auto px-12 py-3"><?php echo $result2->status_name?></span></div>
                        <?php } elseif($result2->status_id==2){?>
                        <div class="text-gray-500 fw-semibold fs-6">
                  <span class="badge badge-light-primary fw-bold me-auto px-12 py-3"><?php echo $result2->status_name?></span></div>
            <?php } elseif($result2->status_id==4){?>
                        <div class="text-gray-500 fw-semibold fs-6">
                  <span class="badge badge-danger fw-bold me-auto px-12 py-3"><?php echo $result2->status_name?></span></div>
                        <?php 
                        }else{?>
                        <div class="text-gray-500 fw-semibold fs-6">
                  <span class="badge badge-light-success fw-bold me-auto px-12 py-3"><?php echo $result2->status_name?></span></div>
                        <?php 
                        } ?></span>
