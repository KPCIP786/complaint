...
<?php $result2 = $this->db->query("SELECT * FROM grm_nc_tbl AS gnt,grm_uc_tbl AS gut,grc_zone_tbl AS gzt,city as c Where gnt.uc_id=gut.uc_id AND gzt.zone_id=gnt.zone_id AND c.city_id=gnt.city_id AND gnt.nc_id=$aid")->row(); ?>
               ...
               $i=1; 
                  $result1 = $this->db->query("SELECT * FROM grm_nc_tbl AS gnt,grm_uc_tbl AS gut,grc_zone_tbl AS gzt,city as c Where gnt.uc_id=gut.uc_id AND gzt.zone_id=gnt.zone_id AND c.city_id=gnt.city_id AND gnt.city_id=$cityid")->result();
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-flush">
                                                ...
                                                <div class="card-header pt-7">
                                                    <!--begin::Title-->
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-gray-800">Edit NC</span>
                                                        <!-- <span class="text-gray-400 mt-1 fw-semibold fs-6">Updated 37 minutes ago</span> -->
                                                    </h3>
                                                    <!--end::Title-->
...
<select name="uc_id" id="uc_id" class="form-control form-control-solid" style="height: 41px;" >
                                               <option value="<?php echo $result2->uc_id ?>"><?php echo $result2->uc_name ?></option>          
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td><input type="text" name="area" class="form-control form-control-solid" value="<?php echo $result2->area ?>"></td>
                                                         </tr>
                                                           <tr>
                                                        <tr>
