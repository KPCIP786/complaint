...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack flex-wrap">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex title-custom fw-bolder fs-2hx flex-column justify-content-center my-0">Complaint Detail</h1>
											<!--end::Title-->
									...
									<div class="card mb-3">
										<div class="card-body pt-1 pb-0">
											...
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
												...
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="<?php echo base_url('Complaint/complaint_detail/'.$aid)?>">Complaint Detail</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item mt-2">
				...
				<?php 
				$result2 = $this->db->query("SELECT * FROM gre_applicant AS ga,grm_complaint_category As gcc,gre_complaint_detail As gcd,grm_source_tbl As s,ppms_project as pp,ppms_subproject As ps,grc_zone_tbl as gzt,grm_tier_tbl As t,grc_status_tbl As gs where ga.applicant_id=gcd.applicant_id AND gcc.cc_id=gcd.complaint_category_id AND s.source_id=gcd.source_id AND ps.subproject_id=gcd.sub_project_id AND gzt.zone_id=gcd.zone_id AND pp.project_id=ps.project_id AND t.tier_id=gcd.tier_id AND gs.status_id=gcd.status_id AND gcd.complaint_detail_id=$aid")->row();
                         ...
                         <!--begin::Menu-->
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px pb-15" data-kt-menu="true">
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <!--begin::Menu-->
                                                            <div class="me-0">
                                                                <a href="<?php echo base_url('Complaint/unresolved_complaint_detail/'.$aid)?>" class="btn btn-sm btn-danger me-3" >
                                                                   Mark as inprogress
                                                                </a>
                                                            </div>
                                                            <!--end::Menu-->
                                    ...
                                    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                                        ...
                                        <div class="card-header cursor-pointer">
                                            ...
                                            <div class="card-title m-0">
                                                <h3 class="fw-bold m-0">Complaint Details</h3>
                                            </div>
                                            <!--end::Card title-->
                                        ...
                                        <div class="card-body p-9">
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Complaint Date</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <span class="fw-bold fs-6 text-gray-800"><?php echo $result2->complaint_date
                                                    ;?></span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Complaint Category</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8">
                                                    <span class="fw-bold fs-6 text-gray-800"><?php echo $result2->cc_name
                                                    ;?></span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Source
                                                ...
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <span class="fw-bold fs-6 text-gray-800 me-2"><?php echo $result2->source_name;?> </span>
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Subproject
                                                <span class="ms-1" data-bs-toggle="tooltip" aria-label="Phone number must be active" data-bs-original-title="Phone number must be active" data-kt-initialized="1">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <span class="fw-bold fs-6 text-gray-800 me-2"><?php echo $result2->project_name." ".$result2->subproject_name." ".$result2->detail;?> </span>
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Zone
                                                <span class="ms-1" data-bs-toggle="tooltip" aria-label="Phone number must be active" data-bs-original-title="Phone number must be active" data-kt-initialized="1">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <span class="fw-bold fs-6 text-gray-800 me-2"><?php echo $result2->zone_name;?> </span>
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Complaint Title
                                                <span class="ms-1" data-bs-toggle="tooltip" aria-label="Phone number must be active" data-bs-original-title="Phone number must be active" data-kt-initialized="1">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <span class="fw-bold fs-6 text-gray-800 me-2"><?php echo $result2->complaint_title;?> </span>
                                            ...
                                            <div class="row mb-7">
                                                <!--begin::Label-->
                                                <label class="col-lg-4 fw-semibold text-muted">Complaint Detail
                                                <span class="ms-1" data-bs-toggle="tooltip" aria-label="Phone number must be active" data-bs-original-title="Phone number must be active" data-kt-initialized="1">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 d-flex align-items-center">
                                                    <span class="fw-bold fs-6 text-gray-800 me-2"><?php echo $result2->complaint_detail;?> </span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            <table class="table table-bordered">
                                                ...
                                                <?php 
                                                    $attachment = $this->db->query("SELECT * FROM grm_attachment where complaint_id=$aid")->result();
                                                    $i=0; 
                                                    foreach($attachment as $res){?>
                                                    <tr>
                                                    <td align="center"><?php echo $res->title ?></td>
                                                    <td align="center"><?php echo $res->remarks ?></td>
                                                    <td align="center">
    <a href="<?php echo base_url()?><?php echo $res->file;?>">
