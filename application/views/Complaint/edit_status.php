										...
										<div class="col-xl-4">
											...
											<div class="card card-flush">
												...
												<div class="card-header pt-7">
													<!--begin::Title-->
													<h3 class="card-title align-items-start flex-column">
														<span class="card-label fw-bold text-gray-800">Edit Status</span>
														<!-- <span class="text-gray-400 mt-1 fw-semibold fs-6">Updated 37 minutes ago</span> -->
													</h3>
													<!--end::Title-->
...
<input type="hidden" placeholder="Enter cc Name" required
        ...
        <table class="table gridexample">
          <tr>
            <td><label class="required fs-6 fw-semibold mb-2">Status</label></td>
            <td>
        <input type="text" autofocus value="<?php echo $result1->status_name;?>" placeholder="Enter status name" required id="country" class="form-control form-control-solid" name="status_name" tabindex="1"></td>
             </tr>
          <tr>
