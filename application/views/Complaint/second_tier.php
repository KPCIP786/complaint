...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack flex-wrap">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex title-custom fw-bolder fs-2hx flex-column justify-content-center my-0">Second Tier</h1>
											<!--end::Title-->
                          ...
                          <div id="kt_app_content" class="app-content">
                                ...
                                <div id="kt_app_content_container" class="app-container container-xxl">
                                 ...
                                 <a href="<?php echo base_url('Complaint/first_tier/'.$aid)?>" class="btn btn-primary">Tier 1
                                       ...
                                       <a href="<?php echo base_url('Complaint/second_tier/'.$aid)?>" class="btn btn-success">Tier 2
                                       </a>
 ...
 <?php if($result2->status_id==2 && $ss ==1){ ?>
                         <!--begin::Menu-->
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px pb-15" data-kt-menu="true">
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <!--begin::Menu-->
                                                            <div class="me-0">
                                                                <a href="<?php echo base_url('Complaint/unresolved_tier2/'.$aid)?>" class="btn btn-sm btn-danger me-3" >
                                                                   Mark as inprogress
                                                                </a>
                                                            </div>
                                                            <!--end::Menu-->
                ...
                if($group=1){
                    ...
                    $result3 = $this->db->query("SELECT * FROM user as u where u.tier_id=2 AND u.city_id=$result5->city_id")->result();
                }else{
                $result3 = $this->db->query("SELECT * FROM user as u where u.tier_id=2 AND u.city_id=$city")->result();
            }
