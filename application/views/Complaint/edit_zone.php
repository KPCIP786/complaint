<?php $ss=$this->session->userdata('userid');
 ...
 ?>
<?php $result = $this->db->query("SELECT * FROM grc_zone_tbl AS gzt,city AS c Where gzt.city_id=c.city_id AND zone_id=$aid")->row(); ?>
											...
											<div class="card card-flush h-md-100">
												...
												<div class="card-header pt-7">
													...
													<h3 class="card-title align-items-start flex-column">
														<span class="card-label fw-bold text-gray-800">Zone</span>
               ...
               $i=1; 
                  $result1 = $this->db->query("SELECT * FROM grc_zone_tbl AS gzt,city AS c Where gzt.city_id=c.city_id")->result();
										...
										<div class="col-xl-4">
											...
											<div class="card card-flush">
												...
												<div class="card-header pt-7">
													<!--begin::Title-->
													<h3 class="card-title align-items-start flex-column">
														<span class="card-label fw-bold text-gray-800">Edit Zone</span>
														<!-- <span class="text-gray-400 mt-1 fw-semibold fs-6">Updated 37 minutes ago</span> -->
													</h3>
													<!--end::Title-->
...
<input type="hidden" placeholder="Enter zone name" required
                         ...
                         <table class="table gridexample">
                                                         ...
                                                         <tr>
                                                             ...
                                                             <td>
                                                                 <select name="city_id" class="form-control form-control-solid" style="height: 41px;">
                                              ...
                                              <option>Select City</option>
                                               ...
                                               foreach($city as $city){
                                                         ...
                                                         <tr>
                                                            <td><label class="required fs-6 fw-semibold mb-2">Zone Name</label></td>
                                                            <td><input type="text" autofocus
                                                                    placeholder="Enter zone name" required
                                                                    id="zone name" class="form-control form-control-solid"
...
$done=$this->db->query("update grc_zone_tbl set zone_name='$zone_name',city_id=$city_id 
where zone_id=$zone_id");    
    
       
    if($done){
    $this->session->set_flashdata('msg','<i>'.'Record Saved Successfully!!'.'</i>');
    redirect(base_url('complaint/view_zone',$data));
        }
