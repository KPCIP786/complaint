										...
										<div class="col-xl-4">
											...
											<div class="card card-flush">
												...
												<div class="card-header pt-7">
													<!--begin::Title-->
													<h3 class="card-title align-items-start flex-column">
														<span class="card-label fw-bold text-gray-800">Add Tier</span>
														<!-- <span class="text-gray-400 mt-1 fw-semibold fs-6">Updated 37 minutes ago</span> -->
													</h3>
													<!--end::Title-->
...
<input type="hidden" class="txt_csrfname" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
                                                    <table class="table gridexample">
                                                        <tr>
                                                    <td><label class="required fs-6 fw-semibold mb-2">Tier name:</label></td>
                        <td><input type="text" autofocus 
                        placeholder="Enter tier name" required
                        id="tier " class="form-control form-control-solid"
                        name="tier_name" tabindex="1"></td>
                             </tr>
                                                     
                                
                                          <tr>  
                        <td><label class="required fs-6 fw-semibold mb-2">Tier days:</label></td>
                        <td><input type="text" autofocus 
