<?php $ss=$this->session->userdata('userid');
 ...
 ?>
               ...
               $i=1; 
                  ...
                  foreach($result1 as $item){?>
                        ...
                        <td><a
    href="<?php echo base_url()?>Complaint/edit_source/<?php echo $item->source_id;?>">
 ...
 $i++;
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="card card-flush">
                                                ...
                                                <div class="card-header pt-7">
                                                    <!--begin::Title-->
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-gray-800">Add Source</span>
                                                        <!-- <span class="text-gray-400 mt-1 fw-semibold fs-6">Updated 37 minutes ago</span> -->
                                                    </h3>
                                                    <!--end::Title-->
                                                    ...
                                                    <table class="table gridexample">
                                                        <tr>
                                                            ...
                                                            <td><input type="text" autofocus
                                                                    ...
                                                                    id="source" class="form-control form-control-solid"
	...
	$done=$this->db->query("insert into grm_source_tbl set source_name='$source_name'");	
