									...
									<ul
										...
										<li class="nav-item">
											...
											<a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab"
												...
												href="#kt_ecommerce_add_product_general">Inprogress</a>
                                      ...
                                      <!--begin:::Tab item-->
										...
										<li class="nav-item">
											...
											<a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
												...
												href="#kt_ecommerce_add_product_complaints">Resolved</a>
			...
			<div class="menu-content fs-6 text-dark fw-bold px-3 py-4">Quick Actions</div>
					...
					<!--begin::Menu separator-->
						...
						<!--begin::Table container-->
									...
									<div class="tab-content"  id="tier_ch">
...
<?php if($city==4){
	...
	<table class="table table-bordered align-middle table-stripped" ><!--begin::Table head-->
			   ...
			   if ($group==1){
			   	$h=1; 
                  $result1 = $this->db->query("SELECT * FROM gre_applicant AS ga,grm_complaint_category As gcc,gre_complaint_detail As gcd,grm_source_tbl As s,ppms_subproject As ps,grm_tier_tbl As t,grc_status_tbl As gs,grc_zone_tbl as gzt,grm_uc_tbl as gut,grm_nc_tbl as gnt,user as u,city as c where ga.applicant_id=gcd.applicant_id AND gcc.cc_id=gcd.complaint_category_id AND s.source_id=gcd.source_id AND ps.subproject_id=gcd.sub_project_id AND t.tier_id=gcd.tier_id AND (gcd.tier_id=1 OR gcd.tier_id=2 OR gcd.tier_id=3 or gcd.tier_id=5) AND gs.status_id=gcd.status_id AND gcd.status_id=2 AND gcd.zone_id=gzt.zone_id AND gcd.uc_id=gut.uc_id AND gcd.nc_id=gnt.nc_id And gcd.user_id=u.user_id AND u.city_id=c.city_id order by gcd.complaint_detail_id DESC")->result();
 ...
 $h++;
               ...
               elseif($group==4 || $group==5) {
			   	$h=1; 
                  $result1 = $this->db->query("SELECT * FROM gre_applicant AS ga,user AS u,grm_complaint_category As gcc,gre_complaint_detail As gcd,grm_source_tbl As s,ppms_subproject As ps,grm_tier_tbl As t,grc_status_tbl As gs,grc_zone_tbl as gzt,grm_uc_tbl as gut,grm_nc_tbl as gnt,city as c where ga.applicant_id=gcd.applicant_id AND gcc.cc_id=gcd.complaint_category_id AND s.source_id=gcd.source_id AND ps.subproject_id=gcd.sub_project_id  AND t.tier_id=gcd.tier_id AND gcd.tier_id=$tierid AND gs.status_id=gcd.status_id AND gcd.status_id=2 AND gcd.zone_id=gzt.zone_id AND gcd.uc_id=gut.uc_id AND gcd.nc_id=gnt.nc_id AND gcd.user_id=u.user_id AND u.city_id=c.city_id AND u.city_id=$city order by gcd.complaint_detail_id DESC")->result();
 ...
 $h++;
			  	...
			  	$h=1; 
                  $result1 = $this->db->query("SELECT * FROM gre_applicant AS ga,user AS u,grm_complaint_category As gcc,gre_complaint_detail As gcd,grm_source_tbl As s,ppms_subproject As ps,grm_tier_tbl As t,grc_status_tbl As gs,grc_zone_tbl as gzt,grm_uc_tbl as gut,grm_nc_tbl as gnt,city as c where ga.applicant_id=gcd.applicant_id AND gcc.cc_id=gcd.complaint_category_id AND s.source_id=gcd.source_id AND ps.subproject_id=gcd.sub_project_id AND t.tier_id=gcd.tier_id AND (gcd.tier_id=1 or gcd.tier_id=2 or gcd.tier_id=3 or gcd.tier_id=5) AND  gs.status_id=gcd.status_id AND gcd.status_id=2 AND gcd.zone_id=gzt.zone_id AND gcd.uc_id=gut.uc_id AND gcd.nc_id=gnt.nc_id AND gcd.user_id=u.user_id AND u.city_id=c.city_id AND u.city_id=$city order by gcd.complaint_detail_id DESC")->result();
      ...
      if ($group==1){
          $h=1; 
                 ...
                 <tr class="gradeX">
                        ...
                        <td><?php echo $item->source_name?></td>
                        <td><?php echo $item->city_name?></td>
                        <td class="text-danger"><?php echo $item->tier_name?></td>
                        <td><?php echo $item->zone_name?></td>
                        <td><?php echo $item->uc_name?></td>
                        <td><?php echo $item->nc_name?></td>
                        <td><?php if($item->status_id==1){?>
 ...
 $h++;
                 ...
                 elseif($group==4 || $group==5) {
          $h=1; 
                  $result1 = $this->db->query("SELECT * FROM gre_applicant AS ga,user AS u,city as c,grm_complaint_category As gcc,gre_complaint_detail As gcd,grm_source_tbl As s,ppms_subproject As ps,grm_tier_tbl As t,grc_status_tbl As gs,grc_zone_tbl as gzt,grm_uc_tbl as gut,grm_nc_tbl as gnt where ga.applicant_id=gcd.applicant_id AND gcc.cc_id=gcd.complaint_category_id AND s.source_id=gcd.source_id AND ps.subproject_id=gcd.sub_project_id  AND t.tier_id=gcd.tier_id AND gcd.tier_id=$tierid AND gs.status_id=gcd.status_id AND gcd.status_id=1 AND gcd.zone_id=gzt.zone_id AND gcd.uc_id=gut.uc_id AND gcd.nc_id=gnt.nc_id AND gcd.user_id=u.user_id AND u.city_id=$city AND u.city_id=c.city_id order by gcd.complaint_detail_id DESC")->result();
                  foreach($result1 as $item){?>
                 <tr class="gradeX">
...
<input type="hidden" class="txt_csrfname" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
							...
							<tr>
								...
								<td>
									...
									<input type="text" autofocus placeholder="Applicant name"  id="cc"
										...
										class="form-control form-control-solid" name="applicant_name" tabindex="1" required 
	 ...
	 <select name="uc_id" id="uc_id" class="form-control form-control-solid" style="height: 41px;" onmouseover="get_zone_new(this.value)"  required>
